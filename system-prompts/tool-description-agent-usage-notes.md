...
- The name parameter is not available in this context — teammates cannot spawn other teammates. Omit it to spawn a subagent.`:""}${ADDITIONAL_USAGE_NOTES}${EXTRA_USAGE_NOTES}
